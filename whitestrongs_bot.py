...
PLAYER_NAMES_FARSI = {
    ...
    "A. Lunin": "آندری لونین",
    "F. Gonzalez": "فران گونزالس",
    "S. Mestre": "سرخیو مستره",
    "D. Carvajal": "دنی کارواخال",
    "E. Militao": "ادر میلیتائو",
    "D. Alaba": "داوید آلابا",
    "J. Vallejo": "خسوس وایخو",
    "F. Garcia": "فران گارسیا",
    "A. Rudiger": "آنتونیو رودیگر",
    "F. Mendy": "فرلاند مندی",
    "J. Ramon": "خاکوبو رامون",
    ...
    "A. Tchouameni": "اوریلین شوامنی",
    "A. Guler": "آردا گولر",
    "L. Vazquez": "لوکاس وازکز",
    ...
    "Rodrygo": "رودریگو",
    "Endrick": "اندریک",
    "G. Garcia": "گونزالو گارسیا",
    "D. Yanez": "دنیل یانز",
    "C. Ancelotti": "کارلو آنچلوتی",
    "D. Ancelotti": "داویده آنچلوتی"
}
